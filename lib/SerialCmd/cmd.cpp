...
unsigned char check_serial_cmd ()
{
	...
	return 0;
	 ...
	 void command_set_wifi_name (void){
		Serial.println("swn");
	 };
	 void command_set_wifi_pass (void){
		Serial.println("swp");
	 };
	 void command_set_mqtt_server_address (void){
Serial.println("swn");
	 };
	 void command_set_mqtt_server_username  (void){
Serial.println("swn");
	 };
	 void command_set_mqtt_server_pass   (void){
Serial.println("swn");
	 };
